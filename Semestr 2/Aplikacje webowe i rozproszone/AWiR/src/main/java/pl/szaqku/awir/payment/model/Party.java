 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Identifier" type="{http://services.szaqku.pl}PartyIdentType" minOccurs="0"/&gt;
 *         &lt;element name="Name" type="{http://services.szaqku.pl}max35text" maxOccurs="4" minOccurs="0"/&gt;
 *         &lt;element name="AdditionalName" type="{http://services.szaqku.pl}max70text" minOccurs="0"/&gt;
 *         &lt;element ref="{http://services.szaqku.pl}Description" minOccurs="0"/&gt;
 *         &lt;element name="UltmName" type="{http://services.szaqku.pl}max70text" minOccurs="0"/&gt;
 *         &lt;element ref="{http://services.szaqku.pl}Address" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Party {
    ...
    @XmlElement(name = "Address", namespace = "http://services.szaqku.pl")
