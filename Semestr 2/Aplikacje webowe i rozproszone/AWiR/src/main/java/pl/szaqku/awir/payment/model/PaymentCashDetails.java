 ...
 *       &lt;sequence&gt;
 *         &lt;element name="TransactionIdentifier" type="{http://services.szaqku.pl}max32Identifier"/&gt;
 *         &lt;element name="BankTransactionIdentifier" type="{http://services.szaqku.pl}max35Identifier" minOccurs="0"/&gt;
 *         &lt;element ref="{http://services.szaqku.pl}PmtCashCategory" minOccurs="0"/&gt;
 ...
 *         &lt;element name="AuthorizedPersonName" type="{http://services.szaqku.pl}max70text" minOccurs="0"/&gt;
 *         &lt;element name="AuthorizedPersonSurname" type="{http://services.szaqku.pl}max70text" minOccurs="0"/&gt;
 *         &lt;element name="AuthorizedPersonIdentity" type="{http://services.szaqku.pl}PayorIdentType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="AuthorizedPersonAddress" type="{http://services.szaqku.pl}AddressType" minOccurs="0"/&gt;
 *         &lt;element name="AuthorizedPersonPhone" type="{http://services.szaqku.pl}max35Identifier" minOccurs="0"/&gt;
 *         &lt;element name="AdditionalNote" type="{http://services.szaqku.pl}max2000text" minOccurs="0"/&gt;
 *         &lt;element ref="{http://services.szaqku.pl}AdditionalDeclaration" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="ATMNetwor" type="{http://services.szaqku.pl}max35text" minOccurs="0"/&gt;
 *         &lt;element name="PaymentBankOffice" type="{http://services.szaqku.pl}max35Identifier" minOccurs="0"/&gt;
 *         &lt;element ref="{http://services.szaqku.pl}Denominations" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class PaymentCashDetails {
    ...
    @XmlElement(name = "PmtCashCategory", namespace = "http://services.szaqku.pl")
    ...
    @XmlElement(name = "Denominations", namespace = "http://services.szaqku.pl")
