 ...
 *       &lt;sequence&gt;
 *         &lt;element name="PayorIdentifier" type="{http://services.szaqku.pl}PayorIdentType"/&gt;
 *         &lt;element name="PaymentFormIdentifier" type="{http://services.szaqku.pl}max7Identifier"/&gt;
 *         &lt;element name="USDescription" type="{http://services.szaqku.pl}max40text" minOccurs="0"/&gt;
 *         &lt;element name="USPaymentPeriod" type="{http://services.szaqku.pl}USPeriodType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
