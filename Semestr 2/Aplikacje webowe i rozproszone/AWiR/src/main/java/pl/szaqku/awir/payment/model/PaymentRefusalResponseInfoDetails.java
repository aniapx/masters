 ...
 *       &lt;sequence&gt;
 *         &lt;element name="BankPaymentRefusalResponseIdentifier" type="{http://services.szaqku.pl}max35Identifier" minOccurs="0"/&gt;
 *         &lt;element name="RefusalAgreement" type="{http://services.szaqku.pl}Indicator"/&gt;
 *         &lt;element name="InfoCode" type="{http://services.szaqku.pl}min1max4text" minOccurs="0"/&gt;
 *         &lt;element name="AdditionalInfo" type="{http://services.szaqku.pl}max105text" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="Customer" type="{http://services.szaqku.pl}Party" minOccurs="0"/&gt;
 *         &lt;element ref="{http://services.szaqku.pl}AdditionalDeclaration" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="PaymenttInfoStatusCode" type="{http://services.szaqku.pl}PmtInfoStatusCode" minOccurs="0"/&gt;
