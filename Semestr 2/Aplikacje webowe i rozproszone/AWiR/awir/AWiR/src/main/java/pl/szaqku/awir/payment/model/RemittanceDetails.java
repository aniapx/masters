 ...
 *         &lt;element name="IssueDate" type="{http://services.szaqku.pl}Date" minOccurs="0"/&gt;
 *         &lt;element name="PaymentDate" type="{http://services.szaqku.pl}Date" minOccurs="0"/&gt;
 *         &lt;element name="AmountPaid" type="{http://services.szaqku.pl}AmountType" minOccurs="0"/&gt;
 *         &lt;element name="AmountDue" type="{http://services.szaqku.pl}AmountType" minOccurs="0"/&gt;
 *         &lt;element name="DocumentRecipient" type="{http://services.szaqku.pl}PartyIdentType" minOccurs="0"/&gt;
 *         &lt;element name="DocumentIssuer" type="{http://services.szaqku.pl}PartyIdentType" minOccurs="0"/&gt;
 *         &lt;element ref="{http://services.szaqku.pl}AdjustmentDetails" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class RemittanceDetails {
    ...
    @XmlElement(name = "AdjustmentDetails", namespace = "http://services.szaqku.pl")
