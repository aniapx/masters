 ...
 *         &lt;element name="CardConcealedNumber" type="{http://www.wi.zut.edu.pl/xsd/payment/v1.0}max25text" minOccurs="0"/&gt;
 *         &lt;element name="CardPassword" type="{http://www.wi.zut.edu.pl/xsd/payment/v1.0}max35text" minOccurs="0"/&gt;
 *         &lt;element name="CardType" type="{http://www.wi.zut.edu.pl/xsd/payment/v1.0}max25text" minOccurs="0"/&gt;
 *         &lt;element name="CardName" type="{http://www.wi.zut.edu.pl/xsd/payment/v1.0}max50text" minOccurs="0"/&gt;
 *         &lt;element name="CardDescription" type="{http://www.wi.zut.edu.pl/xsd/payment/v1.0}max25text" minOccurs="0"/&gt;
 *         &lt;element name="CardOwnerName" type="{http://www.wi.zut.edu.pl/xsd/payment/v1.0}max140text" minOccurs="0"/&gt;
 ...
 *         &lt;element name="CardAccount" type="{http://www.wi.zut.edu.pl/xsd/payment/v1.0}Account" minOccurs="0"/&gt;
 *         &lt;element name="CustomerAccount" type="{http://www.wi.zut.edu.pl/xsd/payment/v1.0}Account" minOccurs="0"/&gt;
 *         &lt;element ref="{http://www.wi.zut.edu.pl/xsd/payment/v1.0}CardLimit" minOccurs="0"/&gt;
 *         &lt;element name="CardBalanceDetails" type="{http://www.wi.zut.edu.pl/xsd/payment/v1.0}BalanceDetailsType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
