 ...
 *         &lt;element name="InfoCode" type="{http://www.wi.zut.edu.pl/xsd/payment/v1.0}min1max4text"/&gt;
 *         &lt;element name="InfoDetails" type="{http://www.wi.zut.edu.pl/xsd/payment/v1.0}max105text" minOccurs="0"/&gt;
