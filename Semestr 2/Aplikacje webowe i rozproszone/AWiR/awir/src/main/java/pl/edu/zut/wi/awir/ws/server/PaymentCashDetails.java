 ...
 *       &lt;sequence&gt;
 *         &lt;element name="TransactionIdentifier" type="{}max32Identifier"/&gt;
 *         &lt;element name="BankTransactionIdentifier" type="{}max35Identifier" minOccurs="0"/&gt;
 *         &lt;element ref="{}PmtCashCategory" minOccurs="0"/&gt;
 *         &lt;element name="CustomerAccount" type="{}Account" minOccurs="0"/&gt;
 *         &lt;element ref="{}OrderedAmount"/&gt;
 *         &lt;element ref="{}ImmediatePmt" minOccurs="0"/&gt;
 *         &lt;element ref="{}RemittanceInformation"/&gt;
 *         &lt;element name="AuthorizedPersonName" type="{}max70text" minOccurs="0"/&gt;
 *         &lt;element name="AuthorizedPersonSurname" type="{}max70text" minOccurs="0"/&gt;
 *         &lt;element name="AuthorizedPersonIdentity" type="{}PayorIdentType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="AuthorizedPersonAddress" type="{}AddressType" minOccurs="0"/&gt;
 *         &lt;element name="AuthorizedPersonPhone" type="{}max35Identifier" minOccurs="0"/&gt;
 *         &lt;element name="AdditionalNote" type="{}max2000text" minOccurs="0"/&gt;
 *         &lt;element ref="{}AdditionalDeclaration" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="ATMNetwor" type="{}max35text" minOccurs="0"/&gt;
 *         &lt;element name="PaymentBankOffice" type="{}max35Identifier" minOccurs="0"/&gt;
 *         &lt;element ref="{}Denominations" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class PaymentCashDetails {
    ...
    protected PmtCashCatCode pmtCashCategory;
     ...
     *     
     */
    public PmtCashCatCode getPmtCashCategory() {
     ...
     *     
     */
    public void setPmtCashCategory(PmtCashCatCode value) {
